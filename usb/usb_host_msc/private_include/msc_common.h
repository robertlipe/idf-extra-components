 ...
 *
 * This function significantly improves performance with usage of Virtual File System, which creates its own buffer for each opened file.
 * The VFS buffer is then used for USB transfers too, which eliminates need of 2 large buffers and unnecessary copying of the data.
